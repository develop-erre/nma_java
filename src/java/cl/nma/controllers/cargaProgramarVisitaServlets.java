 ...
 */
@WebServlet(name = "cargaProgramarVisitaServlets", urlPatterns = {"/programarVisita"})
public class cargaProgramarVisitaServlets extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet cargaProgramarVisitaServlets</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet cargaProgramarVisitaServlets at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(cargaProgramarVisitaServlets.class.getName()).log(Level.SEVERE, null, ex);
        }
