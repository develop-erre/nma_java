...
-- Schema no_mas_accidentes
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `no_mas_accidentes` DEFAULT CHARACTER SET utf8 ;
...
CREATE TABLE IF NOT EXISTS `no_mas_accidentes`.`visita` (
  ...
  `comentario_documentacion` VARCHAR(200) NULL,
  `instalacion` TINYINT NULL,
  `baños` TINYINT NULL,
  `comedores` TINYINT NULL,
  `comentarios_faena` VARCHAR(200) NULL,
  `seguridad` TINYINT NULL,
  `peligros` TINYINT NULL,
  `comentarios_seguridad` VARCHAR(200) NULL,
  `comentarios_propuesta` VARCHAR(200) NULL,
...
CREATE TABLE IF NOT EXISTS `no_mas_accidentes`.`asesoria` (
  ...
  `comentarios_detectados` VARCHAR(500) NULL,
